...
const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <div className={`relative w-full h-screen overflow-hidden bg-black ${className}`}>
      ...
      {logoSrc && (
        <div className="absolute top-6 left-6 z-20 hero-fade-down">
          <img
            src={logoSrc}
            alt="logo"
            className="w-14 h-14 object-contain drop-shadow-[0_0_12px_rgba(234,88,12,0.6)]"
          />
        </div>
      )}
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white">
        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
          <div className="space-y-2">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-orange-300 via-yellow-400 to-amber-300 bg-clip-text text-transparent hero-fade-up hero-delay-200">
              {headline.line1}
            </h1>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-yellow-300 via-orange-400 to-red-400 bg-clip-text text-transparent hero-fade-up hero-delay-400">
              {headline.line2}
            </h1>
          </div>

          <div className="max-w-3xl mx-auto hero-fade-up hero-delay-600">
          ...
          {buttons && (
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10 hero-fade-up hero-delay-800">
              {buttons.primary && (
                <button
